...
namespace CourseraAssignments.AdvancedAlgorithms.Week1
{
    class Evaquate
    {
        ...
        //    long nodeCount = Count[0];
        //    long edgeCount = Count[1];
        ...
        public static long Solve(long nodeCount, long edgeCount, long[][] edges)
        {
            ...
            long Result = network.EdmondsKarp();
        ...
        public class Network
        {
            ...
            public Tuple<List<Edge>, long> BFS()
            {
                ...
                if (!Marked[Target.Index]) return new Tuple<List<Edge>, long>(new List<Edge>(), long.MaxValue);

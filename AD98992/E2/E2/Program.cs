...
namespace E2
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            long[] nodeWeight = new long[] { 3, 4, 2, 3 };
            long startnode = 1;
            long endnode = 4;
            long res = Solve(nodeCount, EdgeCount, edges, nodeWeight, startnode, endnode);
            Console.WriteLine(res);
        }

        public static long Solve(long nodeCount,
